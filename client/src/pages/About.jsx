...
export default function About() {
  ...
  return (
    <div className="page-enter mx-auto max-w-2xl px-5 py-14 text-center sm:px-8">
      <div className="mx-auto mb-6 h-28 w-28 overflow-hidden rounded-full bg-parchment shadow-soft">
        {avatarUrl && <img src={avatarUrl} alt={writerName} className="h-full w-full object-cover" />}
      </div>
      ...
      {aboutContent && (
        <p className="mx-auto mt-4 max-w-md whitespace-pre-line text-sm leading-relaxed text-ink/70">
          {aboutContent}
        </p>
      )}
